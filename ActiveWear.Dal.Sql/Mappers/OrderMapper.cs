...
namespace ActiveWear.Dal.Sql.Mappers
{
    ...
    {
        internal static Domain.OrderItem ToDomain(this EF.OrderItem orderItem)
        {
        ...
        internal static Domain.Order ToDomain(this EF.Order dalEntity)
        {
        ...
        internal static EF.Order ToDal(this Domain.Order order)
        {
        ...
        internal static EF.OrderItem ToDal(this Domain.OrderItem orderItem)
        {
